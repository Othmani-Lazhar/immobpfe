                ...
                <ul class="navigation">
                    ...
                    <li class="menu-dropdown">
                        <a href="#">
                            ...
                            <span class="mm-text">Utilisateurs</span>
                            <span class="fa fa-angle-down pull-right"></span>
                        </a>
                        <ul class="sub-menu">
                            <li>
                                <a href="events_list.html">
                                    <i class="text-primary menu-icon fa fa-fw fa-list"></i>  Liste utilisateurs
                                </a>
                            </li>
                            <li>
                                <a href="event_item.html">
                                    <i class="text-info menu-icon fa fa-fw fa-fast-forward"></i> Ajouter
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="admin_coupon.html">
                            <i class="text-primary  menu-icon fa fa-scissors"></i>
                            <span class="mm-text">Paiement</span>
                        </a>
                    </li>
